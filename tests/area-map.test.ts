...
// Dropkick has, and which tests stand for each. A map nobody checks decays into a list of paths that
// used to exist, so this reads the real file and holds it to what is on disk. Dropkick's paths are
