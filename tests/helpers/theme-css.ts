...
// contrast. The light tokens live in the first top-level :root block; the dark
// tokens live in the :root block inside @media (prefers-color-scheme: dark).
// Light tokens alias Tailwind's palette, so `var(--color-*)` references resolve
// through Tailwind's theme.css, whose colors are OKLCH.
