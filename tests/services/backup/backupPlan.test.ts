...
import type { BackupCandidate, BackupIndex } from "../../../src/services/backup/backupTypes";
...
function row(over: Partial<BackupIndex[number]> = {}): BackupIndex[number] {
  return {
