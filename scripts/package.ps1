...
# after the Cargo crate (dropkick), not the productName.
Compress-Archive -Path "src-tauri/target/release/dropkick.exe" -DestinationPath "artifacts/$AppName-$Version-win.zip" -Force
