...
// app (the interface language must be read before then; see
// i18n::align_appkit). It uses the same home directory Tauri's path resolver
// returns and creates nothing; None if the home or the override cannot be
// resolved.
