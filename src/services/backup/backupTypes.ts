...
// in the file); otherwise it is read lazily and only if the plan marks the file
// changed.
...
// A file the run could not back up (unreadable, no id yet, case collision). Never
// fatal — the backup captures whatever else it can and records the skip.
