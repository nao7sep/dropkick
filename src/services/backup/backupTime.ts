...
// Formats an instant as "yyyymmdd-hhmmss-fff-utc" in UTC. This is the run stamp
// and also the archive's stem (backup-<stamp>.zip), so it is filename-safe and
// sorts chronologically as a plain string. Millisecond-precision: existing index
// rows recorded before this precision was added keep their whole-second stamp
// as-is (never migrated) — see BackupIndexEntry.archivedAt.
