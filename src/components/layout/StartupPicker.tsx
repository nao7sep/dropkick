      ...
      <div className="w-full max-w-lg rounded-lg bg-surface p-8 shadow-lg">
        ...
        <div className="mt-6 flex justify-end border-t border-border pt-4">
          <button
            ...
            disabled={!canLaunch}
            className="min-w-28 rounded-md bg-primary-solid px-4 py-2 font-medium text-ink-inverted transition-colors hover:bg-primary-solid-hover disabled:cursor-not-allowed disabled:bg-background disabled:text-ink-muted"
          >
            Launch
          </button>
        </div>
